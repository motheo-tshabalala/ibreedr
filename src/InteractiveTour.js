...
const tourSteps = [
  ...
  {
    title: "🔍 Search & Filter",
    description: "Use the search bar to find specific breeds. Tap the filter button to narrow down by animal type, price, location, and more.",
    target: "search-filter",
    highlight: "top-bar"
  },
  {
    title: "❤️ Like Animals",
    description: "Tap the HEART button at the bottom of any card to like an animal. This helps sellers know what's popular.",
    target: "like-button",
    highlight: "bottom-center"
  },
  {
    title: "📑 Save to Wishlist",
    description: "Tap the BOOKMARK icon at the top right to save animals to your wishlist for later.",
  ...
  {
    title: "☰ Menu",
    description: "Tap the menu button to access your messages, wishlist, listings, dashboard, and Help Center.",
    target: "menu-button",
    highlight: "top-left"
  },
  {
  ...
  return (
    <>
      ...
      {highlightStyle.width > 0 && (
        <div
          className="fixed rounded-2xl border-2 border-amber-500 shadow-2xl z-50 pointer-events-none transition-all duration-300"
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleNext}
                className="px-5 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 font-medium flex items-center gap-1"
              >
