          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-primary-green/5 rounded-lg border border-primary-green/20">
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>WhatsApp Number <span className="text-gold-accent text-[10px] font-medium">Recommended</span></span>
              </div>
              <Input
                type="tel"
              ...
              <p className="text-xs text-gray-400 mt-1">
                Buyers prefer WhatsApp for quick replies
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Vaccinations, health status, vet checks..."
                rows={3}
                className="mt-1"
              />
            </div>
